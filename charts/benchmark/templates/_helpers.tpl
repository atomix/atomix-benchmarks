...
store image name
*/}}
{{- define "benchmark.store.imagename" -}}
{{- if .Values.store.image.tag -}}
{{- if .Values.store.image.registry -}}
{{- printf "%s/" .Values.store.image.registry -}}
{{- end -}}
{{- printf "%s:" .Values.store.image.repository -}}
{{- .Values.store.image.tag -}}
{{- else -}}
""
{{- end -}}
{{- end -}}
