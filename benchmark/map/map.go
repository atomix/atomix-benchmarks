...
func (s *MapBenchmarkSuite) SetupBenchmarkMapEntries(c *benchmark.Context) {
	key := params.RandomString(c.GetArg("key-length").Int(8))
...
func (s *MapBenchmarkSuite) BenchmarkMapEntries(b *benchmark.Benchmark) {
	b.Run(func(key string, value []byte) error {
